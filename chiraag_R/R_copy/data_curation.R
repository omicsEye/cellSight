...
###Merging the meta data and the data####
df_merge <- merge(wound1,meta_wound1,by = 0, all = T)
df_merge <- t(df_merge)
####Saving the combined dataset####
write.table(df_merge,"transpose/Wound1_full_transpose.tsv",  sep = "\t", eol = "\n", quote = F, col.names = NA, row.names = T)
...
###Merging the meta data and the data####
df_merge <- merge(wound2,meta_wound2,by = 0, all = T)
df_merge <- t(df_merge)
####Saving the combined dataset####
write.table(df_merge,"transpose/Wound2_full_transpose.tsv",  sep = "\t", eol = "\n", quote = F, col.names = NA, row.names = T)
...
###Merging the meta data and the data####
df_merge <- merge(nonwound1,meta_nonwound1,by = 0, all = T)
df_merge <- t(df_merge)
####Saving the combined dataset####
write.table(df_merge,"transpose/Nonwound1_full_transpose.tsv",  sep = "\t", eol = "\n", quote = F, col.names = NA, row.names = T)
...
###Merging the meta data and the data####
df_merge <- merge(nonwound2,meta_nonwound2,by = 0, all = T)
df_merge <- t(df_merge)
####Saving the combined dataset####
write.table(df_merge,"transpose/Nonwound2_full_transpose.tsv",  sep = "\t", eol = "\n", quote = F, col.names = NA, row.names = T)
