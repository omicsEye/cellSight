...
filtering<-function(obj_list,index=1,min_rna = 200,nfeature_rna = 2500,ncount_rna = 8000,mit.percent = 1,sample_type=NULL,sample_name=NULL,stepwise = FALSE,outpt_directory){
